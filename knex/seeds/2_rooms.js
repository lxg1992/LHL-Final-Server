  ...
  return knex('rooms').del()
    .then(function () {
      ...
      return knex('rooms').insert([
        {host_id: '1', datetime_start:'2019-11-23 16:00:00', datetime_end:'2019-11-23 18:00:00', room_name: 'past room with javascript, database and sql', room_hash: 'seed1', is_active: 'false', tags_created: JSON.stringify(['Javascript', 'Database', 'SQL'])},
        {host_id: '1', datetime_start:'2019-12-01 00:00:00', datetime_end:'2019-12-23 18:00:00', room_name: 'current room with javascript', room_hash: 'seed2', is_active: 'false', tags_created: JSON.stringify(['Javascript'])},
        {host_id: '1', datetime_start:'2019-11-24 00:00:00', datetime_end:'2019-12-30 23:59:59', room_name: 'current room with javascript, database and sql', allow_anonymous:'true',room_hash: 'seed3', is_active: 'true', tags_created: JSON.stringify(['Javascript', 'Database', 'SQL'])},
