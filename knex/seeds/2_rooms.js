  ...
  return knex('rooms').del()
    .then(function () {
      ...
      return knex('rooms').insert([
        ...
        {host_id: '1', datetime_start:'2019-11-24 00:00:00', datetime_end:'2019-12-30 23:59:59', room_name: 'current room with javascript, database and sql', room_hash: 'seed3', is_active: 'true', tags_created: JSON.stringify(['Javascript', 'Database', 'SQL'])},
