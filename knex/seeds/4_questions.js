  ...
  return knex('questions').del()
    .then(function () {
      ...
      return knex('questions').insert([
        ...
        /*7*/{guest_id: 7, room_id: 3, query: 'You should not be able to see this question', tags_selected: JSON.stringify([]),created_at: knex.fn.now()},
        /*8*/{guest_id: 8, room_id: 3, query: 'You shouldn\'t be able to see this either', tags_selected: JSON.stringify(['Ban','me','please']), created_at: '2019-11-25 18:01:45'},
      
        
        /*9*/ {guest_id: 9, room_id: 6, query: 'How do I connect to a database', tags_selected: JSON.stringify(['Database']), created_at: '2019-11-23 17:00:25'},
        /*10*/{guest_id: 10, room_id: 6, query: 'How do I connect to a database', tags_selected: JSON.stringify(['Database']), created_at: '2019-11-23 17:00:35'},
        /*11*/{guest_id: 11, room_id: 6, query: 'How do I connect to a database', tags_selected: JSON.stringify(['Database']), created_at: '2019-11-23 17:00:40'},
        /*12*/{guest_id: 12, room_id: 6, query: 'What is Python and Javascript and database', tags_selected: JSON.stringify(['Javascript', 'Python','Database']), created_at: '2019-11-23 17:01:40'}
