  ...
  return knex('questions').del()
    .then(function () {
      ...
      return knex('questions').insert([
        ...
        {user_id: 3, room_id: 3, query: 'Is Javascript faster than Ruby', tags_selected: JSON.stringify(['Javascript'])},
        ...
        {user_id: 6, room_id: 6, query: 'What is Python and Javascript and database', tags_selected: JSON.stringify(['Javascript', 'Python','Database'])}
